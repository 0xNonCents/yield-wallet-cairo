...
from contracts.erc20.ERC20_base import (
    ERC20_initializer, ERC20_allowances, ERC20_approve, ERC20_transfer, ERC20_mint, ERC20_burn)
from contracts.erc20.Ownable_base import (
...
func constructor{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    Ownable_initializer(owner=recipient)
    return ()
end
