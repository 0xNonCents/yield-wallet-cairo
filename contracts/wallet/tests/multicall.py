...
async def test_multicall(get_starknet):
    ...
    multicall = await deploy(starknet, "./Multicall.cairo")
    erc20_1 = await deploy(starknet, "./ERC20.cairo")
    erc20_2 = await deploy(starknet, "./ERC20.cairo")
    ...
    response = await multicall.multicall([
        ...
        erc20_1.contract_address, get_selector_from_name(
            'balance_of'), 1, user1,
        erc20_2.contract_address, get_selector_from_name(
            'balance_of'), 1, user2
    ]).call()
